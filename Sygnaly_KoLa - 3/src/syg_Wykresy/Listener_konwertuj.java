	...
	public void actionPerformed(ActionEvent arg0) {
		...
		try {
			...
			if (this.konwersja.getKrokZmian() == 1) {
				...
				((JTabbedPane) this.splitPane.getComponent(1)).getTabComponentAt(2).setEnabled(
						false);
				((JTabbedPane) this.splitPane.getComponent(1)).setEnabledAt(2, false);
				...
				if (msgPoprawnosc == "ok") {
					...
					// blokada panelu z parametrami sygnału i z filtrem
					...
					boolean czyFiltracjaOdblokowana = (this.konwersja.getKrokZmian() != 2);
					((JTabbedPane) this.splitPane.getComponent(1)).getTabComponentAt(2).setEnabled(
							czyFiltracjaOdblokowana);
					((JTabbedPane) this.splitPane.getComponent(1)).setEnabledAt(2,
							czyFiltracjaOdblokowana);
