...
import syg_Wykresy.Litener_wyswietlWykres;
...
public class PanelParametry extends javax.swing.JPanel {
	...
	private JLabel ustawLabel(JLabel _lbl, String _txt, int _id) {
		_lbl = new JLabel();
		this.add(_lbl, new GridBagConstraints(0, _id, 1, 1, 0.0, 0.0, GridBagConstraints.EAST,
	...
	private JButton ustawButton(JButton _btn, String _txt, int _id) {
		_btn = new JButton();
		this.add(_btn, new GridBagConstraints(0, _id, 2, 1, 0.0, 0.0, GridBagConstraints.EAST,
	...
	private JFormattedTextField ustawTextField(JFormattedTextField _tf, String _txt, int _id) {
		...
		this.add(_tf, new GridBagConstraints(1, _id, 0, 1, 0.0, 0.0, GridBagConstraints.CENTER,
				GridBagConstraints.HORIZONTAL, new Insets(5, 5, 5, 5), 0, 0));
	...
	private JComboBox<String> ustawComboBox(JComboBox<String> _cb, String[] _labels, int _id,
		...
		this.add(_cb, new GridBagConstraints(0, _id, 1, 1, 1.0, 0.0, GridBagConstraints.EAST,
				GridBagConstraints.HORIZONTAL, new Insets(5, 5, 5, 5), 0, 0));
	...
	public void odczytajParametryZSygnalu(Sygnal _sygnal, int _id) {
		...
		if (_sygnal.getrodzaj() == rodzaj_sygnalu.CIAGLY) {
			...
			txt_Amplituda.setText("");
			txt_CzasPoczatkowy.setText(Double.toString(_sygnal.gett1()));
			txt_CzasTrwania.setText(Double.toString(_sygnal.getd()));
			txt_OkresPodstawowy.setText("");
			txt_Skok.setText("");
			txt_WspolczynnikWypenienia.setText("");
		}
	}
	...
	private void initGUI() {
		try {
			...
			actionListener_w = new Litener_wyswietlWykres(this.listaSygnaow[0], this, this.rysunek,
					this.splitPane);
			if (this.rysujWykres) {
